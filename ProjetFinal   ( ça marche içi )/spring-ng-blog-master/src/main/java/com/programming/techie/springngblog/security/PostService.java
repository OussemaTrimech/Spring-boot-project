...
import com.programming.techie.springngblog.model.*;
...
public class PostService {
    ...
    public Comment updateComment(Long commentId, CommentDto commentDto) {
        ...
        // Update the fields of the comment entity based on the data in the DTO
    ...
    private Comment mapFromDtoToComment(CommentDto commentDto) {
        ...
        comment.setContent(commentDto.getContent());
        comment.setCreatedOn(Date.from(Instant.now()));
        return comment;
    }
