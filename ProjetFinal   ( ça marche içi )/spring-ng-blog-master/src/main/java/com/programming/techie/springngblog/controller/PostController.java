...
*/
    ...
    public ResponseEntity<Comment> createComment(@PathVariable Long postId, @Valid @RequestBody CommentDto commentDto) {
        Comment createdComment = postService.createComment(postId, commentDto);
    ...
    public ResponseEntity<Comment> updateComment(@PathVariable Long commentId, @Valid @RequestBody CommentDto commentDto) {
        Comment updatedComment = postService.updateComment(commentId, commentDto);
